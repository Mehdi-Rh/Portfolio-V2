let resumeData = {
  ...
  education: [
    ...
    {
      UniversityName: 'University of Science and Technology of Oran - Mohamed Boudiaf',
  ...
  portfolio: [
...

    {
      ...
      description:
        'AI Research Explorer - a web application that allows users to search, analyze, and interact with research content using AI capabilities.',
      imgurl: 'images/myImages/screenshots/Portfolio-3.png',
      liveUrl: 'https://ai-research-explorer-psi.vercel.app/',
      sourceUrl: 'https://github.com/Mehdi-Rh/AI-Research-Explorer?tab=readme-ov-file',
      skills: ['React', 'Typescript', 'Material UI', 'Cohere AI'],
    },
    {
      name: 'Bookit Mern',
      description:
        'This is a learning portfolio project where I converted the Booking App built by Brad (owner of Traversy Media) from NextJS to a MERN-based project to sharpen my skills in this stack. Guest credentials: email: guest@example.com password: guest@example.com2025CAP',
